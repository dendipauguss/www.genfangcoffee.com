...
$pdf->Cell(25.5,0.7,"Laporan Paling Laku",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(4.5, 0.8, 'Id Masakan', 1, 0, 'C');
...
$tabel1="detail_order";
$tabel2="masakan";
$query=$ok->laporan_laku($tabel1,$tabel2);
while($lihat=mysqli_fetch_array($query)){
	$pdf->Cell(1, 0.8, $no , 1, 0, 'C');
	$pdf->Cell(4.5, 0.8, $lihat['id_masakan'], 1, 0,'C');
...
$pdf->Output("laporan_Masakan_Paling_Laku-GCoffe.pdf","I");
